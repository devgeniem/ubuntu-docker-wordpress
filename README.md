...
git clone --depth 1 -b php81-stable-sok-3 git@github.com:devgeniem/ubuntu-docker-wordpress.git ubuntu-docker-wordpress_php81-stable-sok-3
...
docker buildx build --platform linux/amd64,linux/amd64/v2,linux/amd64/v3,linux/arm64,linux/ppc64le,linux/s390x,linux/arm/v7 -t devgeniem/ubuntu-docker-wordpress:php81-stable-sok-3 ubuntu-docker-wordpress_php81-stable-sok-3/ubuntu-8.1
# docker buildx build --platform linux/amd64 -t devgeniem/ubuntu-docker-wordpress:php81-stable-sok-3 ubuntu-docker-wordpress_php81-stable-sok-3/ubuntu-8.1 --load
```
